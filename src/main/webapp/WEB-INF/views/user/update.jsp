...
<h2 align="center"> Update details</h2>
  <br/>
    <div align="center">
    <br>
    <s:form  method="POST" modelAttribute="user" action="${pageContext.request.contextPath}/user/update">
   ...
   <label class="cast">User Address</label><input type="text" name="address" id="u_address">
    <br/>
    <br/>
